...
3. 组会收获。 TYL主讲[优化](http://ydwiki.yidian-inc.com/pages/viewpage.action?pageId=29646044), 讲述过程中tan轮到runtime-only, complierOnly 等陌生概念. vue3 sourceCode
...
上周日跟学弟学妹们吃了一顿俄罗斯菜，挺有意思。周末什么也没做，雅儒姐姐，请你加油，你最近太懈怠了。昨天做梦梦到回到了南开本部的宿舍里，碰到了赵欢，从五宿宿舍望出去，看到了化学楼和小迎河。激动地喊了一声我终于回南开了，想回学校了～，CTL 估计是要离职了，这要被逼一下
1. 星期二终于洋洋洒洒的看完了重学前端, 在 19 年的小尾巴。今天得知涂润秋考上了选调生，恭喜恭喜～
2. 春节出行计划正在规划中，初步暂定三亚度假, 这个计划最后在实际考察中暂告一段了，取消掉。春节去三亚，简直就是去送钱，还是不要做这样的事情了
3. webpack 的系统性学习 && 数据结构

## 2019-12-23 —— 2019-12-29
上周末公司开了年会，我也参加了人生中第一次工作年会，一个奖项也没中，我就慢慢攒运气吧，最终抽中一个大的。这周也确定取消了三亚之旅或者是西双版纳之旅。ctl 也要离开 yidian 了，真好，我也想离开。我要变强，变得更强，到更好的地方去
1. webpack 学习，目前收获还是挺多的，想按照官方的文档将代码写一遍，放到 Github 上，以下是问题所在
- package.json 中 private 改为 true 有什么影响，去掉 main 字段，含义所在
- npx webpack 的含义所在 
2. 数据结构的学习，实践
3. 了解 npm init 之后产生的 package.json 文件中的具体信息
